    ...
    <div class="header-top">
      <div class="container">
            ...
            <li class="header-top-link">
                ...
                <span class="loginn">
                    ...
                    <form action="{{route('logout')}}" method="post">
                        @csrf
                        <button class="loginn" type="submit">Logout</button>
                    </form>
                    @else
        ...
        <div class="wrapper">
         ...
         <button class="header-top-btn" @if(session('UserId'))onclick="location.href='AddHome'" @else onclick="LoginAlert()" @endif>Add Ad </button>
        </div>
          ...
          <div class="navbar-bottom">
            <ul class="navbar-list">
              ...
              <li>
               ...
               <li>
                <a href="{{route('price')}}" class="navbar-link" data-nav-link>Predict</a>
               </li>
      ...
      <section class="hero" id="home">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-text">
              Residential real estate is the most widely used among the types of real estate, where everyone is looking for real estate for sale or rent to be able to live and settle in,
            </p>
          ...
          <ul class="service-list">
            ...
            <li>
              <div class="service-card">
                ...
                <a href="BuyPage" class="card-link">
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3 card-title">
                  <a href="RentPage">Rent a home</a>
                </h3>

                <p class="card-text">
                  over 1 million+ homes for rent available on the website, we can match you with a house you will want
                  to call home.
                </p>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3 card-title">
                  <a @if(session('UserId'))href="AddHome" @else href="Login" ُ@endif>Add a home</a>
                </h3>
                ...
                <a  @if(session('UserId')) href="AddHome" @else href="Login" @endif class="card-link">
                  <span>Find A Home</span>
      ...
      <div class="container">
        ...
        <div class="footer-link-box">
          ...
          <ul class="footer-list">
            ...
            <li>
              <a href="Profile" class="footer-link">My account</a>
            </li>
